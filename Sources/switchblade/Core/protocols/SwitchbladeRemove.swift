...
public protocol SwitchbadeRemove {
    ...
    @discardableResult func remove(keyspace: String, key: PrimaryKeyType) -> Bool
    ...
    @discardableResult func remove(partition: String, keyspace: String, key: PrimaryKeyType) -> Bool
