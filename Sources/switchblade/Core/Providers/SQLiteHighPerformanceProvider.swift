...
//    fileprivate var partitionSeen: [String] = []
//    fileprivate var partitionLocks: [String:Mutex] = [:]
//    fileprivate var partitionConnections: [Data:OpaquePointer] = [:]
//    
...
//    }
//    
//    fileprivate func obtainLock(partition: String, keyspace: String) -> Mutex {
//        
//        var lock: Mutex?
//        
//        schemalock.mutex {
...
//    }
//    
//    fileprivate func obtainDatabase(partition: String, keyspace: String) -> OpaquePointer {
//        
//        var db: OpaquePointer?
//        
//        schemalock.mutex {
//            db = partitionConnections[keyspace]
//        }
//        
//        // deliberately fragile to promote correct order of execution
//        return db!
...
//    }
//    
//    fileprivate func makeId(_ key: String,_ keyspace: Data) -> Data {
//        var id = Data(key)
//        id.append(keyspace)
//        return id.sha224()
//    }
...
//    }
//    
//    func put(key: String, keyspace: Data, object: Data?, queryKeys: [Data]?) -> Bool {
...
//    }
//    
//    public func put<T>(key: String, keyspace: Data, _ object: T) -> Bool where T : Decodable, T : Encodable {
//        
//        let names = makeTableNames(keyspace: keyspace)
//        
...
//    }
//    
//    public func delete(key: String, keyspace: Data) -> Bool {
//        if let logServer = self.config.logDriver {
...
//    
//    @discardableResult
//    public func get<T>(key: String, keyspace: Data) -> T? where T : Decodable, T : Encodable {
//        let id = makeId(key, keyspace)
//        let names = makeTableNames(keyspace: keyspace)
//        do {
//            if config.aes256encryptionKey == nil {
